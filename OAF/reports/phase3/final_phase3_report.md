...
_Generated 2026-08-27T15:38:21.805999+00:00. Seed 42. Test set untouched during model selection._
...
|---|---|---|---|---|---|---|---|---|
| vgg16 | 0.6680 | 0.7074 | 0.6754 | 0.7117 | 0.8373 | 0.5474 | 0.7192 | 0.7117 |
| convnext_tiny | 0.6704 | 0.7055 | 0.6786 | 0.7160 | 0.8398 | 0.5491 | 0.7083 | 0.7160 |
| vgg19 | 0.6422 | 0.7024 | 0.6607 | 0.7190 | 0.8367 | 0.5229 | 0.7098 | 0.7190 |
...
| googlenet | 0.6276 | 0.6695 | 0.6356 | 0.6866 | 0.7992 | 0.4940 | 0.6621 | 0.6866 |
...
| shufflenet | 0.6074 | 0.6473 | 0.5994 | 0.6476 | 0.7621 | 0.4502 | 0.6620 | 0.6476 |
...
| squeezenet | 0.5929 | 0.6340 | 0.5878 | 0.6275 | 0.7528 | 0.4361 | 0.6738 | 0.6275 |

### Per-class F1 (validation)

| model | kl0_f1 | kl1_f1 | kl2_f1 | kl3_f1 | kl4_f1 |
|---|---|---|---|---|---|
| vgg16 | 0.7867 | 0.4153 | 0.5855 | 0.8308 | 0.9189 |
| convnext_tiny | 0.7789 | 0.4053 | 0.6212 | 0.8220 | 0.9000 |
| vgg19 | 0.7256 | 0.4085 | 0.6230 | 0.8318 | 0.9231 |
...
| googlenet | 0.7259 | 0.3695 | 0.5921 | 0.7599 | 0.9000 |
...
|---|---|---|---|---|---|---|---|---|
| vgg16 | 134281029 | 512.253 | 15.466 | 3.036 | 3.022 | 329.410 | 2092.840 | 56.806 |
| convnext_tiny | 27823973 | 106.198 | 4.470 | 3.329 | 3.275 | 300.360 | 421.280 | 22.927 |
| vgg19 | 139590725 | 532.510 | 19.628 | 3.638 | 3.754 | 274.910 | 2158.650 | 62.738 |
...
| googlenet | 5605029 | 21.536 | 1.504 | 3.497 | 3.473 | 285.950 | 153.720 | 14.568 |
...
| shufflenet | 1258729 | 4.966 | 0.148 | 3.438 | 3.365 | 290.830 | 86.590 | 7.599 |
...
| squeezenet | 725061 | 2.784 | 0.263 | 1.349 | 1.310 | 741.540 | 82.960 | 4.616 |

## 11. Confusion matrices

See `reports/phase3/confusion_matrices/` (raw + normalized per model).
...
See `reports/phase3/training_curves/`.
...
|---|---|---|---|---|---|---|---|---|
| vgg16 | 0.7074 | 0.8373 | 0.7117 | 1 | 2 | 5 | 14 | 4.2500 |
| convnext_tiny | 0.7055 | 0.8398 | 0.7160 | 2 | 1 | 6 | 13 | 4.0167 |
| vgg19 | 0.7024 | 0.8367 | 0.7190 | 3 | 3 | 10 | 15 | 5.3833 |
| densenet121 | 0.6932 | 0.8136 | 0.6934 | 4 | 4 | 15 | 8 | 6.4833 |
| inception_v3 | 0.6872 | 0.7849 | 0.6948 | 5 | 7 | 13 | 11 | 7.3333 |
| xception | 0.6870 | 0.7778 | 0.6864 | 6 | 8 | 11 | 10 | 8.2833 |
| efficientnet_b1 | 0.6776 | 0.7901 | 0.6866 | 7 | 6 | 12 | 7 | 7.2833 |
| googlenet | 0.6695 | 0.7992 | 0.6866 | 8 | 5 | 9 | 6 | 6.9167 |
| resnet50 | 0.6625 | 0.7767 | 0.6782 | 9 | 9 | 4 | 12 | 8.7000 |
| mobilenet_v3_large | 0.6592 | 0.7559 | 0.6677 | 10 | 14 | 7 | 5 | 9.7333 |
| resnet18 | 0.6479 | 0.7688 | 0.6545 | 11 | 11 | 2 | 9 | 9.8167 |
| shufflenet | 0.6473 | 0.7621 | 0.6476 | 12 | 13 | 8 | 2 | 10.6000 |
| mobilenet_v2 | 0.6440 | 0.7644 | 0.6650 | 13 | 12 | 3 | 3 | 9.3000 |
| efficientnet_b0 | 0.6403 | 0.7713 | 0.6643 | 14 | 10 | 14 | 4 | 11.1000 |
| squeezenet | 0.6340 | 0.7528 | 0.6275 | 15 | 15 | 1 | 1 | 10.8000 |

- **Performance ranking** (Macro-F1 -> QWK -> balanced acc): vgg16, convnext_tiny, vgg19, densenet121, inception_v3, xception, efficientnet_b1, googlenet, resnet50, mobilenet_v3_large, resnet18, shufflenet, mobilenet_v2, efficientnet_b0, squeezenet
- **Efficiency ranking** (latency -> params): squeezenet, resnet18, mobilenet_v2, resnet50, vgg16, convnext_tiny, mobilenet_v3_large, shufflenet, googlenet, vgg19, xception, efficientnet_b1, inception_v3, efficientnet_b0, densenet121

## 19. Recommended model

**Primary (highest validation Macro-F1): `vgg16`** - Macro-F1=0.7074, QWK=0.8373, balanced acc=0.7117, KL4-F1=0.9189, 134.3M params, 3.04 ms/img.

Apply the decision framework (spec section 35): if a much smaller/faster model is within a small Macro-F1 margin and matches on QWK / KL3-KL4 F1, prefer it. See the Pareto plots (`reports/phase3/`). Final call stated below with evidence.
...
|---|---|---|---|---|---|---|---|---|
| vgg16 | 0.6680 | 0.7074 | 0.7117 | 0.8373 | 0.9189 | 134.2800 | 512.2530 | 3.0357 |
| convnext_tiny | 0.6704 | 0.7055 | 0.7160 | 0.8398 | 0.9000 | 27.8200 | 106.1980 | 3.3294 |
| vgg19 | 0.6422 | 0.7024 | 0.7190 | 0.8367 | 0.9231 | 139.5900 | 532.5100 | 3.6375 |
...
| googlenet | 0.6276 | 0.6695 | 0.6866 | 0.7992 | 0.9000 | 5.6100 | 21.5360 | 3.4971 |
...
| shufflenet | 0.6074 | 0.6473 | 0.6476 | 0.7621 | 0.9333 | 1.2600 | 4.9660 | 3.4385 |
...
| squeezenet | 0.5929 | 0.6340 | 0.6275 | 0.7528 | 0.8986 | 0.7300 | 2.7840 | 1.3485 |